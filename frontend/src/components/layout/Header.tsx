      ...
      <div className="flex h-16 items-center justify-between px-4 sm:px-6">
        ...
        <div className="flex items-center gap-3">
                  ...
                  >
                    <div className="flex items-center justify-between p-4 border-b border-border">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <button onClick={clearNotifications} className="p-1 hover:bg-muted rounded-lg transition-colors">
                      ...
                      {notifications.length === 0 ? (
                        ...
                        notifications.map((n) => (
                          <button
                            ...
                            className={`w-full text-left p-3 border-b border-border/50 hover:bg-muted transition-colors flex gap-3 ${n.read ? 'opacity-60' : ''}`}
                          >
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              <div className="w-8 h-8 rounded-full bg-[hsl(var(--ojas-100))] flex items-center justify-center text-xs font-bold text-[hsl(var(--ojas-700))] dark:bg-[hsl(var(--ojas-800))] dark:text-[hsl(var(--ojas-200))]">
